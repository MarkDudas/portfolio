  ...
  return (
    <div className="bg-white  h-100v%  grid grid-cols-2 gap-4 p-4">
      <div className="flex items-center justify-center flex-col col-span-1 span">
        ...
        <p className='text-xl  max-md:text-sm max-md:text-center'>Hi, I am Mark Angelo B. Dudas, an aspiring frontend developer.</p>
      ...
      <div className="col-span-1 span flex items-center justify-center">
        <img className='w-96  h-96 max-md:h-44 max-md:w-44 span' src={pic} alt="Mark Angelo B. Dudas" />
